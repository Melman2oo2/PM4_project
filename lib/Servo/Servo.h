...
public:
    ...
    // getCurrentVelocity implementiert durch Akermleo

    /**
     * @brief returns the current velocity
     *
     * @return velocity the current value from the motion planer
     */
    ...
    /**
     * @brief returns the motion profile acceleration.
     *
     * @return acceleration The acceleration value from the motion profile.
     */
    ...
    /**
     * @brief returns the goal pulse with
     *
     * @return the goal pulse with
     */
    float getTargetPulseWith();
