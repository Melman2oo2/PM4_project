...
// getProfileAcceleration implementiert durch Akermleo

/**
 * Gets the profile acceleration value.
 * @return the acceleration value of this motion, given in [m/s^2] or [rad/s^2].
 */
float Motion::getProfileAcceleration() {
